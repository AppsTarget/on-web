            ...
            @for($i = 0; $i < sizeof($modalidades); $i++)
                ...
                @if($quebra == 26)
                    ...
                    <section class="sheet padding-10mm">
                        ...
                        <div style="width: 100%">
                            ...
                            <h3 class="text-center" style="margin-bottom:15px">Resumo Contratos/Vendas</h3>
                ...
                <tr style="font-size:12px; text-transform:uppercase;
                    @if($i%2==0) 
                        background: #d7d7d7;
                    @endif ">
                    <td>{{$modalidades[$i]->descr}}</td>
                    <td class="text-right">{{ $modalidades[$i]->qtd }}</td>
                    <td class="text-right">R$ {{ number_format($modalidades[$i]->total,2,",",".") }}</td>
                    <td class="text-right">R$ 0,00</td>
                    <td class="text-right">R$ {{ number_format($modalidades[$i]->total,2,",",".") }}</td>
                </tr> 
                @if ($i == (sizeof($modalidades) - 1))
                    <tr>
                        <td></td>
                        <td colspan="4" style='font-size: 35px;text-align:right'>
                            Total:
