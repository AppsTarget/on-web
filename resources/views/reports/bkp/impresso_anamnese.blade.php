...
<body class="A4">
    <section class="sheet padding-10mm">
        ...
        <h4 style='text-align:end;margin-top: -35px;'>{{$anamnese_pessoa->data}}         {{$anamnese_pessoa->hora}}</h4>
        <div class="row">
            <table>
                <thead>
                ...
                <tbody>
                    @for($i = 0; $i < sizeof($respostas)-1; $i++)
                        @if($i%2==0)
                            <tr style='background-color: #d8d8d8;font-size: 12px;color:black'>
    ...
    <script type="text/javascript">
        function download_pdf() {
            ...
            //     $('.sheet')[0],
            //     function () {
            //         pdf.save('{{ getEmpresaObj()->descr }} - Contrato #{{ str_pad($anamnese->id, 6, "0", STR_PAD_LEFT) }}.pdf');
