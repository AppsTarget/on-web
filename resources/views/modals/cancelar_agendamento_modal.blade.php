<!-- Modal -->
<div class="modal fade" id="cancelarAgendamentoModal" aria-labelledby="cancelarAgendamentoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="/saude-beta/agenda/cancelar-agendamento" method="POST">
                @csrf
                <div class="modal-header">
                    <h6 class="modal-title header-color" id="cancelarAgendamentoModalLabel">Cancelar Agendamento</h6>
