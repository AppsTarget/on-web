...
<!-- Modal -->
<div class="modal fade" id="cadastrarTituloReceberModal" aria-labelledby="cadastrarTituloReceberModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title header-color header-color" id="cadastrarTituloReceberModalLabel">Cadastrar Título a Receber</h6>
            ...
            <form>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-3 form-group d-flex" style="justify-content: space-between">
                                <div class="tipo-titulo-selected" style="width: 95px; cursor: pointer" onclick="setarTipoTituloReceber('unico')" data-tipo="titulo-unico">
                                    <span>
                                        Título Único
                                    </span>
                                </div>
                                <div style="width: 128px; cursor: pointer" onclick="setarTipoTituloReceber('parcelado')" data-tipo="parcelado">
                                    <span>
                                        Título Parcelado
                                    </span>
                                </div>
                            ...
                            <div class="col-4 form-group">
                                <label for="valor-titulo-receber" class="custom-label-form">Valor:</label>
                                <input id="valor-titulo-receber" class="custom-form form-control money-brl text-right" type="text">
                            </div>
                            ...
                            <div class="col-2 form-group -p" style="padding: 0px 90px 0px 5px;">
                                <label id="id-parcelas-t-receber" for="n-parcela" class="custom-label-form">N. Parcela</label>
                                <input id="n-parcela" name="n-parcela" class="form-control" type="number">
                            </div>
                            <div class="col-1 form-group" style="display: none">
                                <div style="cursor: pointer;background-color: #0f67d5;color: white;opacity: 1;padding: 10px 20px 6px 50%;border-radius: 2px;text-transform: uppercase;margin-left: -152%;margin-top: 38%;position: relative;top: 2px;" onclick="CalcularParcelasTitulosReceber()">
                                    Calcular
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex">
                    <button type="button" onclick="salvarTituloReceber()" class="btn btn-target mx-auto my-3 px-5">
                        Confirmar
                    </button>
                </div>
            </form>
