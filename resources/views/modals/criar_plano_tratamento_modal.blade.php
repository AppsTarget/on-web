<!-- Modal -->
<div class="modal fade" id="criarPlanoTratamentoModal" aria-labelledby="criarPlanoTratamentoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document" style="max-width:95%">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title header-color" id="criarPlanoTratamentoModalLabel">Criar Contrato</h6>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form action="/saude-beta/pedido/salvar" method="POST" onsubmit="salvar_plano_tratamento(event)">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <h5 id="status_plano_tratamento" class="col text-right">
                                Aberto
                            </h5>
                        </div>
                                ...
                                <div class="custom-table">
                                    <div class="table-header-scroll">
                                        <table>
                                            <thead>
                                                <tr>
                                                    <th width="27.5%">Profissional</th>
                                                    <th width="27.5%">procedimento</th>
                                    ...
                                    <div>
                                        <table id="table-plano-tratamento-procedimentos" class="table table-hover">
                                            <tbody>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="custom-table">
                                    <div class="table-header-scroll">
                                        <table>
                                            <thead>
                                                <tr>
                                                    <th width="22.5%">Forma de Pagamento</th>
                                                    <th width="22.5%">Financeiro</th>
                                    ...
                                    <div>
                                        <table id="table-plano-tratamento-forma-pag" class="table table-hover">
                                            <tbody>
                                            </tbody>
                                        </table>
                                    </div>
                        ...
                        <div class="row">
                            <button id="btn-cancelar-pedido" class="btn btn-danger mx-auto my-3 px-6" onclick="mudar_status_pedido('C'); return false;">
                                Cancelar
                            </button>

                            <button id="btn-salvar-pedido" type="submit" class="btn btn-target mx-auto my-3 px-6">
                                Salvar
                            </button>

                            <button id="btn-concluir-pedido" class="btn btn-success mx-auto my-3 px-6" onclick="mudar_status_pedido('E'); return false;">
                                Concluir Orçamento
                            </button>

                            <button id="btn-finalizar-pedido" class="btn btn-success mx-auto my-3 px-6" onclick="prosseguir_pedido(); return false;">
                                Finalizar
                            </button>
                        </div>
                    </form>
