...
<div class="container-fluid h-100 px-3 py-4">
    <div class="row">
        <h3 class="col header-color mb-3">Etiquetas | Grade</h3>
        <div id="filtro-grid" class="input-group col-12 mb-3" data-table="#table-etiquetas">
    ...
    <div class="custom-table card">
        <div class="table-header-scroll">
            <table>
                <thead>
                    <tr class="sortable-columns" for="#table-etiquetas">
        ...
        <div class="table-body-scroll">
            <table id="table-etiquetas" class="table table-hover">
                <tbody>
                    @foreach ($etiquetas as $etiqueta)
                        <tr>
                            <td width="10%" class="text-right">{{ $etiqueta->id }}</td>
                            <td width="70%">{{ $etiqueta->descr }}</td>
                            <td width="10%">
                            ...
                            <td width="10%" class="text-center btn-table-action">
                                <i class="my-icon far fa-edit" onclick="editar_etiqueta({{ $etiqueta->id }})"></i>
                                <i class="my-icon far fa-trash-alt" onclick="deletar_etiqueta({{ $etiqueta->id }})"></i>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
...
<button class="btn btn-primary custom-fab" type="button" data-toggle="modal" data-target="#etiquetaModal">
